...
This is an **ArcKit architecture governance project** — not a software codebase. It generates architecture documents (markdown) for the **Defence AI Strategy & Operational Assurance Platform** at Ministry of Defence.
...
Expected artifacts for project 001 (Defence AI Strategy & Operational Assurance Platform):
...
- `ARC-001-MSBD-v1.0.md` — MOD Secure by Design
- `ARC-001-JSP9-v1.0.md` — JSP 936 AI Assurance

## Project Context

The Ministry of Defence (MoD) defends the UK and its interests. The Defence AI Strategy positions AI as essential for maintaining operational advantage. MoD is adopting AI across intelligence analysis, logistics, maintenance prediction, and autonomous systems while ensuring compliance with JSP 936 (AI Assurance) and international humanitarian law. The Defence AI Centre (DAIC) leads AI adoption across Defence.

### Compliance Context

UK Government ministerial department (defence). Applicable frameworks: JSP 604 (Information Security), JSP 936 (AI Assurance), NCSC Cyber Assessment Framework, MOD Secure by Design, Defence AI Strategy, NATO AI principles, HM Treasury Green Book, DEFSTAN standards, International Humanitarian Law.

### Key Stakeholders

MoD (policy owner), Defence AI Centre (DAIC), Defence Science and Technology Laboratory (Dstl), Defence Digital, single services (Army, Navy, RAF), Strategic Command, defence industry (BAE, QinetiQ, Thales), NATO allies.
